...
// SET PITCHVEC TO heading(90,90):vector.
// SET STEERVEC TO VECDRAWARGS(
// 	V(0,0,0),
// 	PITCHVEC,
// 	RGB(1,0,0),
// 	"steering",
...
// 	PRINT "PITCH @ " + ROUND(PITCH,2) AT(2,3).
// 	PRINT "90-t @ " + ROUND(90 - TURNANGLE,2) AT(2,4).
// 	PRINT "a-ts  @ " + ROUND(ALT - TURNSTART,2) AT(2,5).
// 	PRINT "a-te  @ " + ROUND(TURNEND - TURNSTART,2) AT(2,6).
// 	SET STEERVEC:VEC TO	PITCHVEC.
}
...
PRINT "ORBIT ACHIEVED.  SAS OFF.  HAPPY SPACEFARING!" AT(2,30).
